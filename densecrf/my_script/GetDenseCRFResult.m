...
%
directory_path = fullfile('/home/rasha/work/DeepLab-Context', 'matlab', 'my_script');
...
if learn_crf
  ...
  map_folder = fullfile('/home/rasha/work/DeepLab-Context', dataset, 'densecrf', feature_name, model_name, testset, feature_type, post_folder); 
  ...
  map_folder = fullfile('/home/rasha/work/DeepLab-Context', dataset, feature_name, model_name, testset, feature_type, post_folder); 
